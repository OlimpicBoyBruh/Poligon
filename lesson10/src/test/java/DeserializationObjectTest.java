...
public class DeserializationObjectTest {
    ...
    public void deserializationByteTest() {
        try (InputStream is = Files.newInputStream(Path.of("src/test/resources/artist_by_country.serialized"));
    ...
    public void deserializationXmlTest() {
        ...
        File file = new File("src/test/resources/artist_by_country.xml");
        try {
    ...
    public void deserializationJsonTest() {
        ...
        File file = new File("src/test/resources/artist_by_country.json");
        try {
